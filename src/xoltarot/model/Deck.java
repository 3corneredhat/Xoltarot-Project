...
public class Deck {
	...
	public Deck() {
		...
		tarotCard = new Card(0 ,"The Fool", "The Fool is a card of new beginnings, " 
		...
		tarotCard = new Card(1, "The Magician", "As a master manifestor, the " 
		...
		tarotCard = new Card(2, "The High Priestess", "The High Priestess is the guardian of the "
		...
		tarotCard = new Card(3, "The Empress", "The Empress signifies a strong connection with our femininity. Femininity "
		...
		tarotCard = new Card(4, "The Emperor", "The Emperor represents a powerful leader who demands respect and authority. Status, power and "
		...
		tarotCard = new Card(5, "The Hierophant","The Hierophant card represents an established set of spiritual values and beliefs and is often "
		...
		tarotCard = new Card(6, "The Lovers", "The Lovers card represents conscious connections and meaningful relationships. "
		...
		tarotCard = new Card(7, "The Chariot", "The Chariot is a card of willpower, determination and strength. You have discovered how to make decisions in "
		...
		tarotCard = new Card(8, "Strength", "The Strength card represents strength, determination, and power - like the Chariot. However, while the Chariot "
		...
		tarotCard = new Card(9, "The Hermit", "The Hermit shows that you are taking a break from everyday life to draw your energy and attention inward and find the answers "
		...
		tarotCard = new Card(10, "The Wheel of Fortune", "The Wheel of Fortune reminds you that the wheel is always turning and life is in a state of constant change. If you're going "
		...
		tarotCard = new Card(11, "Justice" , "The Justice card represents justice, fairness, truth and the law. You are being called to account for your actions and will be judged "
		...
		tarotCard = new Card(12, "The Hanged Man", "The Hanged Man reminds you that sometimes you have to put everything on hold before you can take the next step, or the Universe "
		...
		tarotCard = new Card(13, "Death", "After a period of pause and reflection with the Hanged Man, the Death card symbolises the end of a major phase or aspect of your life that you "
		...
		tarotCard = new Card(14, "Temperance", "Temperance is the card for bringing balance, patience and moderation into your life. You are being invited to stabilise your energy and "
		...
		tarotCard = new Card(15,"The Devil", "The Devil card represents your shadow (or darker) side and the negative forces that constrain you and hold you back from being the best "
		...
		tarotCard = new Card(16, "The Tower", "When the Tower card appears in a Tarot reading, expect the unexpected - massive change, upheaval, destruction and chaos. It may be a divorce, "
		...
		tarotCard = new Card(17, "The Star", "As the Star follows the Tower card in the Tarot, it comes as a welcome reprieve after a period of destruction and turmoil. You have endured many "
		...
		tarotCard = new Card(18, "The Moon", "The Moon represents your fears and illusions and often comes out when you are projecting fear into your present and your future, based on your past "
		...
		tarotCard = new Card(19, "The Sun", "The Sun represents success, radiance and abundance. The Sun gives you strength and tells you that no matter where you go or what you do, your positive "
		...
		tarotCard = new Card(20, "Judgement", "The Judgement card is calling you to rise up and embrace a higher level of consciousness for the service of your Highest Good. You are experiencing a "
		...
		tarotCard = new Card(21, "The World", "When the World card appears in a Tarot reading, you are glowing with a sense of wholeness, achievement, fulfilment and completion. A long-term project, "
